...
const TermsConditionsView = (): React.JSX.Element => {
  return (
    <div className='z-2 container relative'>
      <br></br>
      <h1>Terms & Conditions</h1>
      <p>Updated at 2023-06-01</p>

      <br></br>
      <h1>General Terms</h1>
      <p>
        By accessing and placing an order with New Yolk, you confirm that you are in agreement with and bound by the
        terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and
        any email or other type of communication between you and New Yolk.
      </p>
      <p>
        Under no circumstances shall New Yolk team be liable for any direct, indirect, special, incidental or
        consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the
        inability to use, the materials on this site, even if New Yolk team or an authorized representative has been
      ...
      <p>
        New Yolk will not be responsible for any outcome that may occur during the course of usage of our resources. We
      ...
      <h1>License</h1>
      <p>
        New Yolk grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use
        the website strictly in accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and New Yolk (referred to in these Terms & Conditions as
        &quot;New Yolk&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the New Yolk Farm
        website and the services accessible from the New Yolk website (which are collectively referred to in these Terms
        & Conditions as the &quot;New Yolk Service&quot;).
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions,
        please do not use the New Yolk Service. In these Terms & Conditions, &quot;you&quot; refers both to you as an
      ...
      <ul>
        ...
        <li>
          Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to New Yolk S.R.L., Str. Mos
          Pitar 27, Sector 1, Bucharest that is responsible for your information under this Terms & Conditions.
        </li>
        <li>Country: where New Yolk or the owners/founders of New Yolk are based, in this case is</li>
        <li>
          Device: any internet connected device such as a phone, tablet, computer or any other device that can be used
          to visit New Yolk and use the services.
        </li>
        <li>
          Service: refers to the service provided by New Yolk as described in the relative terms (if available) and on
          this platform.
        </li>
        <li>
        ...
        <li>Website: New Yolk&apos;s site, which can be accessed via this URL: www.ssp.io</li>
        <li>You: a person or entity that is registered with New Yolk to use the Services.</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of New Yolk
          Farm or its affiliates, partners, suppliers or the licensors of the website.
        </li>
      </ul>
      <br></br>
      <h1>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at New Yolk. We appreciate the fact that you like to buy the stuff we build. We also want to
        make sure you have a rewarding experience while you&apos;re exploring, evaluating, and purchasing our products.
      </p>
      <p>
        As with any shopping experience, there are terms and conditions that apply to transactions at New Yolk.
        We&apos;ll be as brief as our attorneys will allow. The main thing to remember is that by placing an order or
        making a purchase at New Yolk, you agree to the terms along with New Yolk&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        you to New Yolk with respect to the website shall remain the sole and exclusive property of New Yolk Farm.
      </p>
      <p>
        New Yolk shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and in any
      ...
      <p>
        ...
        operated or controlled by New Yolk. We are not responsible for the content, accuracy or opinions expressed in
      ...
      <h1>Cookies</h1>
      <p>
        New Yolk uses &quot;Cookies&quot; to identify the areas of our website that you have visited. A Cookie is a
      ...
      <p>
        You acknowledge and agree that New Yolk may stop (permanently or temporarily) providing the Service (or any
        features within the Service) to you or to users generally at sole discretion, without prior notice to you. You
        may stop using the Service at any time. You do not need to specifically inform New Yolk when you stop using the
        Service. You acknowledge and agree that if New Yolk disables access to your account, you may be prevented from
      ...
      <p>
        New Yolk reserves the right to modify, suspend or discontinue, temporarily or permanently, the website or any
      ...
      <p>
        New Yolk may from time to time provide enhancements or improvements to the features/ functionality of the
        website, which may include patches, bug fixes, updates, upgrades and other modifications (&quot;Updates&quot;).
      </p>
      <p>
        Updates may modify or delete certain features and/or functionalities of the website. You agree that New Yolk
        Farm has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular features
      ...
      <p>
        You acknowledge and agree that New Yolk shall not be responsible for any Third-Party Services, including their
        accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other
        aspect thereof. New Yolk does not assume and shall not have any liability or responsibility to you or any other
      ...
      <p>This Agreement shall remain in effect until terminated by you or New Yolk.</p>
      <p>
        New Yolk may, in its sole discretion, at any time and for any or no reason, suspend or terminate this Agreement
        with or without prior notice.
      </p>
      <p>
        This Agreement will terminate immediately, without prior notice from New Yolk, in the event that you fail to
      ...
      <p>
        Termination of this Agreement will not limit any of New Yolk&apos;s rights or remedies at law or in equity in
      ...
      <p>
        You agree to indemnify and hold New Yolk and its parents, subsidiaries, affiliates, officers, employees, agents,
      ...
      <p>
        ...
        without warranty of any kind. To the maximum extent permitted under applicable law, New Yolk, on its own behalf
        ...
        practice. Without limitation to the foregoing, New Yolk provides no warranty or undertaking, and makes no
      ...
      <p>
        Without limiting the foregoing, neither New Yolk nor any New Yolk&apos;s provider makes any representation or
        ...
        the website; or (iv) that the website, its servers, the content, or e-mails sent from or on behalf of New Yolk
      ...
      <p>
        Notwithstanding any damages that you might incur, the entire liability of New Yolk and any of its suppliers
      ...
      <p>
        To the maximum extent permitted by applicable law, in no event shall New Yolk or its suppliers be liable for any
        ...
        this Agreement), even if New Yolk or any supplier has been advised of the possibility of such damages and even
      ...
      <p>
        This Agreement, together with the Privacy Policy and any other legal notices published by New Yolk on the
        Services, shall constitute the entire agreement between you and New Yolk concerning the Services. If any
        ...
        such term or any other term, and New Yolk&apos;s failure to assert any right or provision under this Agreement
        shall not constitute a waiver of such right or provision. YOU AND New Yolk AGREE THAT ANY CAUSE OF ACTION
      ...
      <p>
        New Yolk reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
      ...
      <p>
        ...
        revised terms. If you do not agree to the new terms, you are no longer authorized to use New Yolk.
      </p>

      <br></br>
      <h1>Entire Agreement</h1>
      <p>
        The Agreement constitutes the entire agreement between you and New Yolk regarding your use of the website and
        supersedes all prior and contemporaneous written or oral agreements between you and New Yolk.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when you use or purchase other New Yolk
        Farm&apos;s services, which New Yolk will provide to you at the time of such use or purchase.
      </p>
      ...
      <p>
        ...
        by New Yolk, its licensors or other providers of such material and are protected by and international copyright,
        ...
        prior written permission of New Yolk, unless and except as is expressly provided in these Terms & Conditions.
      ...
      <p>
        ...
        OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR New Yolk&apos;s INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other controversy between you and New Yolk Farm
      ...
      <p>
        In the event of a dispute, you or New Yolk must give the other a Notice of Dispute, which is a written statement
        ...
        <a href='mailto:contact@ssp.io'>&nbsp;contact@ssp.io</a>. New Yolk will send any Notice of Dispute to you by
        mail to your address if we have it, or otherwise to your email address. You and New Yolk Farm will attempt to
        resolve any dispute through informal negotiation within sixty (60) days from the date the Notice of Dispute is
        sent. After sixty (60) days, you or New Yolk may commence arbitration.
      </p>

      <br></br>
      <h1>Binding Arbitration</h1>
      <p>
        If you and New Yolk don&apos;t resolve any dispute by informal negotiation, any other effort to resolve the
      ...
      <p>
        ...
        non-confidential and non-proprietary and will become the sole property of New Yolk without any compensation or
        credit to you whatsoever. New Yolk and its affiliates shall have no obligations with respect to such submissions
      ...
      <h1>Promotions</h1>
      <p>
        New Yolk may, from time to time, include contests, promotions, sweepstakes, or other activities (“Promotions”)
        that require you to submit material or information concerning yourself. Please note that all Promotions may be
      ...
      <p>
        ...
        authorized representative of New Yolk. New Yolk will be entitled to injunctive or other equitable relief
        (without the obligations of posting any bond or surety) in the event of any breach or anticipatory breach by
        you. New Yolk operates and controls the New Yolk Service from its offices in . The Service is not intended for
        distribution to or use by any person or entity in any jurisdiction or country where such distribution or use
        would be contrary to law or regulation. Accordingly, those persons who choose to access the New Yolk Service
        from other locations do so on their own initiative and are solely responsible for compliance with local laws, if
        and to the extent local laws are applicable. These Terms & Conditions (which include and incorporate the New
        Yolk Privacy Policy) contains the entire understanding, and supersedes all prior understandings, between you and
        New Yolk concerning its subject matter, and cannot be changed or modified by you. The section headings used in
        this Agreement are for convenience only and will not be given any legal import.
      </p>

      <br></br>
      <h1>Disclaimer</h1>
      <p>New Yolk is not responsible for any content, code or any other imprecision.</p>
      <p>New Yolk does not provide warranties or guarantees.</p>
      <p>
        In no event shall New Yolk be liable for any special, direct, indirect, consequential, or incidental damages or
      ...
      <p>
        The New Yolk Service and its contents are provided &quot;as is&quot; and &quot;as available&quot; without any
        warranty or representations of any kind, whether express or implied. New Yolk is a distributor and not a
        publisher of the content supplied by third parties; as such, New Yolk exercises no editorial control over such
        content and makes no warranty or representation as to the accuracy, reliability or currency of any information,
        content, service or merchandise provided through or accessible via the New Yolk Service. Without limiting the
        foregoing, New Yolk specifically disclaims all warranties and representations in any content transmitted on or
        in connection with the New Yolk Service or on sites that may appear as links on the New Yolk Service, or in the
        products provided as a part of, or otherwise in connection with, the New Yolk Service, including without
        limitation any warranties of merchantability, fitness for a particular purpose or non-infringement of third
        party rights. No oral advice or written information given by New Yolk or any of its affiliates, employees,
        officers, directors, agents, or the like will create a warranty. Price and availability information is subject
        to change without notice. Without limiting the foregoing, New Yolk does not warrant that the New Yolk Service
      ...
      <ul>
        <li>
          Via Email:
          <a href='mailto:contact@ssp.io'>&nbsp;contact@ssp.io</a>
        </li>
        <li>Via Phone Number: +4 0731 955 192</li>
        <li>
          Via this Link:&nbsp;
          <Link href={"/contact"}>https://ssp.io/contact</Link>
        </li>
      </ul>
    </div>
  )
