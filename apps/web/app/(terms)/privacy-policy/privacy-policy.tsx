...
const PrivacyPolicyView = (): React.JSX.Element => {
  return (
    <div className='z-2 container relative'>
      ...
      <br></br>
      <p>
        New Yolk (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your
        personal information is collected, used, and disclosed by New Yolk.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
        alongside our application, New Yolk. By accessing or using our Service, you signify that you have read,
      ...
      <ul>
        ...
        <li>
          ...
          Pitar 27, Sector 1, Bucharest that is responsible for your information under this Privacy Policy.
        </li>
        <li>Country: where New Yolk or the owners/founders of New Yolk are based, in this case is Romania.</li>
        <li>
          Customer: refers to the company, organization or person that signs up to use the New Yolk Service to manage
        ...
        <li>
          Personnel: refers to those individuals who are employed by New Yolk or are under contract to perform a service
        ...
        <li>Website: New Yolk&apos;s site, which can be accessed via this URL: https://www.ssp.io</li>
      ...
      <br></br>
      <h1>When does New Yolk use end user information from third parties?</h1>
      <p>New Yolk will collect End User Data necessary to provide the New Yolk services to our customers.</p>
      <p>
      ...
      <br></br>
      <h1>When does New Yolk use customer information from third parties?</h1>
      <p>
        We receive some information from the third parties when you contact us. For example, when you submit your email
        address to us to show interest in becoming a New Yolk customer, we receive information from a third party that
        provides automated fraud detection services to New Yolk. We also occasionally collect information that is made
      ...
      <p>
        New Yolk will collect personal information that you submit to us. We may also receive personal information about
      ...
      <p>
        We keep your information only so long as we need it to provide New Yolk to you and fulfill the purposes
      ...
      <p>
        ...
        ensure or warrant the absolute security of any information you transmit to New Yolk or guarantee that your
      ...
      <p>
        New Yolk is incorporated in Romania. Information collected via our website, through direct interactions with
      ...
      <br></br>
      <h1>Is the information collected through the New Yolk Service secure?</h1>
      <p>
      ...
      <p>
        The rights you have to request updates or corrections to the information New Yolk collects depend on your
        relationship with New Yolk. Personnel may update or correct their information as detailed in our internal
      ...
      <h1>Personnel</h1>
      <p>
        If you are a New Yolk worker or applicant, we collect information you voluntarily provide to us. We use the
      ...
      <p>
        ...
        of all or substantially all of the assets of New Yolk or any of its Corporate Affiliates (as defined herein), or
        that portion of New Yolk or any of its Corporate Affiliates to which the Service relates, or in the event that
      ...
      <p>
        ...
        controls, is controlled by or is under common control with New Yolk, whether by ownership or otherwise. Any
      ...
      <p>
        By using New Yolk or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not
      ...
      <p>
        ...
        or controlled by New Yolk. We are not responsible for the content, accuracy or opinions expressed in such
      ...
      <p>
        ...
        pixel collects information that is held in accordance with its Privacy Policy
      </p>
      <br></br>
      ...
      <ul>
        ...
        <li>
          Sessions
          <p>
            We use &quot;Sessions&quot; to identify the areas of our website that you have visited. A Session is a small
      ...
      <p>
        ...
        companies and enhances the controlthe EU residents have, over their personal data.
      </p>
      <p>
      ...
      <p>
        ...
        fines for breach. Beyond these facts it&apos;s simply the right thing to do. At New Yolk we strongly believe
      ...
      <p>
        We are committed to helping our customers meet the data subject rights requirements of GDPR. New Yolk processes
