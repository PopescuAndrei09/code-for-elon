...
const AccountForm = ({ me }: { me: Awaited<ReturnType<(typeof serverApi)["user"]["me"]["query"]>> }) => {
  ...
  const defaultValues: Partial<AccountFormValues> = {
    ...
    birthdate: me.birthdate ? new Date(me.birthdate) : undefined,
    country: me.country ?? "",
  ...
  const updateMe = clientApi.user.updateMe.useMutation({
    onSuccess: () => {
