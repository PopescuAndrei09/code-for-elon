...
const ThemeAddForm = ({ setOpenDialogAdd }: { setOpenDialogAdd: React.Dispatch<React.SetStateAction<boolean>> }) => {
  ...
  const CreateNewTheme = clientApi.theme.create.useMutation({
    onSuccess: () => {
      toast.success("Your theme was created successfully. 🎉")
