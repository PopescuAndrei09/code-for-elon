...
const CookiePolicyView = (): React.JSX.Element => {
  return (
    <div className='z-2 container relative'>
      ...
      <ul>
        ...
        <li>
          Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to New Yolk, that is responsible
      ...
      <h1>Introduction</h1>
      <p>
        This Cookie Policy explains how New Yolk and its affiliates (collectively &quot;New Yolk&quot;, &quot;we&quot;,
        &quot;us&quot;, and &quot;ours&quot;), use cookies and similar technologies to recognize you when you visit our
        website, including without limitation https://www.ssp.io and any related URLs, mobile or localized versions and
        related domains / sub-domains (&quot;Websites&quot;). It explains what these technologies are and why we use
      ...
      <br></br>
      <h1>What type of cookies does New Yolk use?</h1>
      <p>
      ...
      <p>
        ...
        be found at: https://www.google.com/policies/privacy-policy/partners/. You can opt-out of all Google supported
      ...
      <p>
        Some cookies that have been set on our website are not set on a first party basis by New Yolk. The Websites can
